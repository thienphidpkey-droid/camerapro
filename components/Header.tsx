        ...
        <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <button 
              ...
              className={`text-sm font-medium transition-colors hover:text-purple-600 dark:hover:text-white ${
                activeView === 'catalogue' ? 'text-purple-600 dark:text-white' : 'text-gray-600 dark:text-gray-300'
              }`}
            >
              Sản phẩm
            </button>
            ...
            <button 
              ...
              className={`text-sm font-medium transition-colors hover:text-purple-600 dark:hover:text-white ${
                activeView === 'news' ? 'text-purple-600 dark:text-white' : 'text-gray-600 dark:text-gray-300'
              }`}
            >
              Tin tức
            </button>
